...
func NewMetricsBuilder(mbc MetricsBuilderConfig, settings receiver.CreateSettings, options ...metricBuilderOption) *MetricsBuilder {
	mb := &MetricsBuilder{
		...
		metricSystemProcessesCount:   newMetricSystemProcessesCount(mbc.MetricsSettings.SystemProcessesCount),
		metricSystemProcessesCreated: newMetricSystemProcessesCreated(mbc.MetricsSettings.SystemProcessesCreated),
	}
