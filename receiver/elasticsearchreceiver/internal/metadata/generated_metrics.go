...
func newMetricElasticsearchClusterPendingTasks(settings MetricSettings) metricElasticsearchClusterPendingTasks {
	m := metricElasticsearchClusterPendingTasks{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchIndexCacheEvictions(settings MetricSettings) metricElasticsearchIndexCacheEvictions {
	m := metricElasticsearchIndexCacheEvictions{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchIndexOperationsMergeDocsCount(settings MetricSettings) metricElasticsearchIndexOperationsMergeDocsCount {
	m := metricElasticsearchIndexOperationsMergeDocsCount{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchIndexOperationsMergeSize(settings MetricSettings) metricElasticsearchIndexOperationsMergeSize {
	m := metricElasticsearchIndexOperationsMergeSize{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchNodeCacheSize(settings MetricSettings) metricElasticsearchNodeCacheSize {
	m := metricElasticsearchNodeCacheSize{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchNodeOperationsCurrent(settings MetricSettings) metricElasticsearchNodeOperationsCurrent {
	m := metricElasticsearchNodeOperationsCurrent{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchProcessCPUTime(settings MetricSettings) metricElasticsearchProcessCPUTime {
	m := metricElasticsearchProcessCPUTime{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchProcessCPUUsage(settings MetricSettings) metricElasticsearchProcessCPUUsage {
	m := metricElasticsearchProcessCPUUsage{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func newMetricElasticsearchProcessMemoryVirtual(settings MetricSettings) metricElasticsearchProcessMemoryVirtual {
	m := metricElasticsearchProcessMemoryVirtual{settings: settings}
	if settings.Enabled {
		m.data = pmetric.NewMetric()
		m.init()
	}
...
func NewMetricsBuilder(mbc MetricsBuilderConfig, settings receiver.CreateSettings, options ...metricBuilderOption) *MetricsBuilder {
	mb := &MetricsBuilder{
		...
		metricElasticsearchBreakerMemoryEstimated:                       newMetricElasticsearchBreakerMemoryEstimated(mbc.MetricsSettings.ElasticsearchBreakerMemoryEstimated),
		metricElasticsearchBreakerMemoryLimit:                           newMetricElasticsearchBreakerMemoryLimit(mbc.MetricsSettings.ElasticsearchBreakerMemoryLimit),
		metricElasticsearchBreakerTripped:                               newMetricElasticsearchBreakerTripped(mbc.MetricsSettings.ElasticsearchBreakerTripped),
		metricElasticsearchClusterDataNodes:                             newMetricElasticsearchClusterDataNodes(mbc.MetricsSettings.ElasticsearchClusterDataNodes),
		metricElasticsearchClusterHealth:                                newMetricElasticsearchClusterHealth(mbc.MetricsSettings.ElasticsearchClusterHealth),
		metricElasticsearchClusterInFlightFetch:                         newMetricElasticsearchClusterInFlightFetch(mbc.MetricsSettings.ElasticsearchClusterInFlightFetch),
		metricElasticsearchClusterIndicesCacheEvictions:                 newMetricElasticsearchClusterIndicesCacheEvictions(mbc.MetricsSettings.ElasticsearchClusterIndicesCacheEvictions),
		metricElasticsearchClusterNodes:                                 newMetricElasticsearchClusterNodes(mbc.MetricsSettings.ElasticsearchClusterNodes),
		metricElasticsearchClusterPendingTasks:                          newMetricElasticsearchClusterPendingTasks(mbc.MetricsSettings.ElasticsearchClusterPendingTasks),
		metricElasticsearchClusterPublishedStatesDifferences:            newMetricElasticsearchClusterPublishedStatesDifferences(mbc.MetricsSettings.ElasticsearchClusterPublishedStatesDifferences),
		metricElasticsearchClusterPublishedStatesFull:                   newMetricElasticsearchClusterPublishedStatesFull(mbc.MetricsSettings.ElasticsearchClusterPublishedStatesFull),
		metricElasticsearchClusterShards:                                newMetricElasticsearchClusterShards(mbc.MetricsSettings.ElasticsearchClusterShards),
		metricElasticsearchClusterStateQueue:                            newMetricElasticsearchClusterStateQueue(mbc.MetricsSettings.ElasticsearchClusterStateQueue),
		metricElasticsearchClusterStateUpdateCount:                      newMetricElasticsearchClusterStateUpdateCount(mbc.MetricsSettings.ElasticsearchClusterStateUpdateCount),
		metricElasticsearchClusterStateUpdateTime:                       newMetricElasticsearchClusterStateUpdateTime(mbc.MetricsSettings.ElasticsearchClusterStateUpdateTime),
		metricElasticsearchIndexCacheEvictions:                          newMetricElasticsearchIndexCacheEvictions(mbc.MetricsSettings.ElasticsearchIndexCacheEvictions),
		metricElasticsearchIndexCacheMemoryUsage:                        newMetricElasticsearchIndexCacheMemoryUsage(mbc.MetricsSettings.ElasticsearchIndexCacheMemoryUsage),
		metricElasticsearchIndexCacheSize:                               newMetricElasticsearchIndexCacheSize(mbc.MetricsSettings.ElasticsearchIndexCacheSize),
		metricElasticsearchIndexDocuments:                               newMetricElasticsearchIndexDocuments(mbc.MetricsSettings.ElasticsearchIndexDocuments),
		metricElasticsearchIndexOperationsCompleted:                     newMetricElasticsearchIndexOperationsCompleted(mbc.MetricsSettings.ElasticsearchIndexOperationsCompleted),
		metricElasticsearchIndexOperationsMergeDocsCount:                newMetricElasticsearchIndexOperationsMergeDocsCount(mbc.MetricsSettings.ElasticsearchIndexOperationsMergeDocsCount),
		metricElasticsearchIndexOperationsMergeSize:                     newMetricElasticsearchIndexOperationsMergeSize(mbc.MetricsSettings.ElasticsearchIndexOperationsMergeSize),
		metricElasticsearchIndexOperationsTime:                          newMetricElasticsearchIndexOperationsTime(mbc.MetricsSettings.ElasticsearchIndexOperationsTime),
		metricElasticsearchIndexSegmentsCount:                           newMetricElasticsearchIndexSegmentsCount(mbc.MetricsSettings.ElasticsearchIndexSegmentsCount),
		metricElasticsearchIndexSegmentsMemory:                          newMetricElasticsearchIndexSegmentsMemory(mbc.MetricsSettings.ElasticsearchIndexSegmentsMemory),
		metricElasticsearchIndexSegmentsSize:                            newMetricElasticsearchIndexSegmentsSize(mbc.MetricsSettings.ElasticsearchIndexSegmentsSize),
		metricElasticsearchIndexShardsSize:                              newMetricElasticsearchIndexShardsSize(mbc.MetricsSettings.ElasticsearchIndexShardsSize),
		metricElasticsearchIndexTranslogOperations:                      newMetricElasticsearchIndexTranslogOperations(mbc.MetricsSettings.ElasticsearchIndexTranslogOperations),
		metricElasticsearchIndexTranslogSize:                            newMetricElasticsearchIndexTranslogSize(mbc.MetricsSettings.ElasticsearchIndexTranslogSize),
		metricElasticsearchIndexingPressureMemoryLimit:                  newMetricElasticsearchIndexingPressureMemoryLimit(mbc.MetricsSettings.ElasticsearchIndexingPressureMemoryLimit),
		metricElasticsearchIndexingPressureMemoryTotalPrimaryRejections: newMetricElasticsearchIndexingPressureMemoryTotalPrimaryRejections(mbc.MetricsSettings.ElasticsearchIndexingPressureMemoryTotalPrimaryRejections),
		metricElasticsearchIndexingPressureMemoryTotalReplicaRejections: newMetricElasticsearchIndexingPressureMemoryTotalReplicaRejections(mbc.MetricsSettings.ElasticsearchIndexingPressureMemoryTotalReplicaRejections),
		metricElasticsearchMemoryIndexingPressure:                       newMetricElasticsearchMemoryIndexingPressure(mbc.MetricsSettings.ElasticsearchMemoryIndexingPressure),
		metricElasticsearchNodeCacheCount:                               newMetricElasticsearchNodeCacheCount(mbc.MetricsSettings.ElasticsearchNodeCacheCount),
		metricElasticsearchNodeCacheEvictions:                           newMetricElasticsearchNodeCacheEvictions(mbc.MetricsSettings.ElasticsearchNodeCacheEvictions),
		metricElasticsearchNodeCacheMemoryUsage:                         newMetricElasticsearchNodeCacheMemoryUsage(mbc.MetricsSettings.ElasticsearchNodeCacheMemoryUsage),
		metricElasticsearchNodeCacheSize:                                newMetricElasticsearchNodeCacheSize(mbc.MetricsSettings.ElasticsearchNodeCacheSize),
		metricElasticsearchNodeClusterConnections:                       newMetricElasticsearchNodeClusterConnections(mbc.MetricsSettings.ElasticsearchNodeClusterConnections),
		metricElasticsearchNodeClusterIo:                                newMetricElasticsearchNodeClusterIo(mbc.MetricsSettings.ElasticsearchNodeClusterIo),
		metricElasticsearchNodeDiskIoRead:                               newMetricElasticsearchNodeDiskIoRead(mbc.MetricsSettings.ElasticsearchNodeDiskIoRead),
		metricElasticsearchNodeDiskIoWrite:                              newMetricElasticsearchNodeDiskIoWrite(mbc.MetricsSettings.ElasticsearchNodeDiskIoWrite),
		metricElasticsearchNodeDocuments:                                newMetricElasticsearchNodeDocuments(mbc.MetricsSettings.ElasticsearchNodeDocuments),
		metricElasticsearchNodeFsDiskAvailable:                          newMetricElasticsearchNodeFsDiskAvailable(mbc.MetricsSettings.ElasticsearchNodeFsDiskAvailable),
		metricElasticsearchNodeFsDiskFree:                               newMetricElasticsearchNodeFsDiskFree(mbc.MetricsSettings.ElasticsearchNodeFsDiskFree),
		metricElasticsearchNodeFsDiskTotal:                              newMetricElasticsearchNodeFsDiskTotal(mbc.MetricsSettings.ElasticsearchNodeFsDiskTotal),
		metricElasticsearchNodeHTTPConnections:                          newMetricElasticsearchNodeHTTPConnections(mbc.MetricsSettings.ElasticsearchNodeHTTPConnections),
		metricElasticsearchNodeIngestDocuments:                          newMetricElasticsearchNodeIngestDocuments(mbc.MetricsSettings.ElasticsearchNodeIngestDocuments),
		metricElasticsearchNodeIngestDocumentsCurrent:                   newMetricElasticsearchNodeIngestDocumentsCurrent(mbc.MetricsSettings.ElasticsearchNodeIngestDocumentsCurrent),
		metricElasticsearchNodeIngestOperationsFailed:                   newMetricElasticsearchNodeIngestOperationsFailed(mbc.MetricsSettings.ElasticsearchNodeIngestOperationsFailed),
		metricElasticsearchNodeOpenFiles:                                newMetricElasticsearchNodeOpenFiles(mbc.MetricsSettings.ElasticsearchNodeOpenFiles),
		metricElasticsearchNodeOperationsCompleted:                      newMetricElasticsearchNodeOperationsCompleted(mbc.MetricsSettings.ElasticsearchNodeOperationsCompleted),
		metricElasticsearchNodeOperationsCurrent:                        newMetricElasticsearchNodeOperationsCurrent(mbc.MetricsSettings.ElasticsearchNodeOperationsCurrent),
		metricElasticsearchNodeOperationsGetCompleted:                   newMetricElasticsearchNodeOperationsGetCompleted(mbc.MetricsSettings.ElasticsearchNodeOperationsGetCompleted),
		metricElasticsearchNodeOperationsGetTime:                        newMetricElasticsearchNodeOperationsGetTime(mbc.MetricsSettings.ElasticsearchNodeOperationsGetTime),
		metricElasticsearchNodeOperationsTime:                           newMetricElasticsearchNodeOperationsTime(mbc.MetricsSettings.ElasticsearchNodeOperationsTime),
		metricElasticsearchNodePipelineIngestDocumentsCurrent:           newMetricElasticsearchNodePipelineIngestDocumentsCurrent(mbc.MetricsSettings.ElasticsearchNodePipelineIngestDocumentsCurrent),
		metricElasticsearchNodePipelineIngestDocumentsPreprocessed:      newMetricElasticsearchNodePipelineIngestDocumentsPreprocessed(mbc.MetricsSettings.ElasticsearchNodePipelineIngestDocumentsPreprocessed),
		metricElasticsearchNodePipelineIngestOperationsFailed:           newMetricElasticsearchNodePipelineIngestOperationsFailed(mbc.MetricsSettings.ElasticsearchNodePipelineIngestOperationsFailed),
		metricElasticsearchNodeScriptCacheEvictions:                     newMetricElasticsearchNodeScriptCacheEvictions(mbc.MetricsSettings.ElasticsearchNodeScriptCacheEvictions),
		metricElasticsearchNodeScriptCompilationLimitTriggered:          newMetricElasticsearchNodeScriptCompilationLimitTriggered(mbc.MetricsSettings.ElasticsearchNodeScriptCompilationLimitTriggered),
		metricElasticsearchNodeScriptCompilations:                       newMetricElasticsearchNodeScriptCompilations(mbc.MetricsSettings.ElasticsearchNodeScriptCompilations),
		metricElasticsearchNodeSegmentsMemory:                           newMetricElasticsearchNodeSegmentsMemory(mbc.MetricsSettings.ElasticsearchNodeSegmentsMemory),
		metricElasticsearchNodeShardsDataSetSize:                        newMetricElasticsearchNodeShardsDataSetSize(mbc.MetricsSettings.ElasticsearchNodeShardsDataSetSize),
		metricElasticsearchNodeShardsReservedSize:                       newMetricElasticsearchNodeShardsReservedSize(mbc.MetricsSettings.ElasticsearchNodeShardsReservedSize),
		metricElasticsearchNodeShardsSize:                               newMetricElasticsearchNodeShardsSize(mbc.MetricsSettings.ElasticsearchNodeShardsSize),
		metricElasticsearchNodeThreadPoolTasksFinished:                  newMetricElasticsearchNodeThreadPoolTasksFinished(mbc.MetricsSettings.ElasticsearchNodeThreadPoolTasksFinished),
		metricElasticsearchNodeThreadPoolTasksQueued:                    newMetricElasticsearchNodeThreadPoolTasksQueued(mbc.MetricsSettings.ElasticsearchNodeThreadPoolTasksQueued),
		metricElasticsearchNodeThreadPoolThreads:                        newMetricElasticsearchNodeThreadPoolThreads(mbc.MetricsSettings.ElasticsearchNodeThreadPoolThreads),
		metricElasticsearchNodeTranslogOperations:                       newMetricElasticsearchNodeTranslogOperations(mbc.MetricsSettings.ElasticsearchNodeTranslogOperations),
		metricElasticsearchNodeTranslogSize:                             newMetricElasticsearchNodeTranslogSize(mbc.MetricsSettings.ElasticsearchNodeTranslogSize),
		metricElasticsearchNodeTranslogUncommittedSize:                  newMetricElasticsearchNodeTranslogUncommittedSize(mbc.MetricsSettings.ElasticsearchNodeTranslogUncommittedSize),
		metricElasticsearchOsCPULoadAvg15m:                              newMetricElasticsearchOsCPULoadAvg15m(mbc.MetricsSettings.ElasticsearchOsCPULoadAvg15m),
		metricElasticsearchOsCPULoadAvg1m:                               newMetricElasticsearchOsCPULoadAvg1m(mbc.MetricsSettings.ElasticsearchOsCPULoadAvg1m),
		metricElasticsearchOsCPULoadAvg5m:                               newMetricElasticsearchOsCPULoadAvg5m(mbc.MetricsSettings.ElasticsearchOsCPULoadAvg5m),
		metricElasticsearchOsCPUUsage:                                   newMetricElasticsearchOsCPUUsage(mbc.MetricsSettings.ElasticsearchOsCPUUsage),
		metricElasticsearchOsMemory:                                     newMetricElasticsearchOsMemory(mbc.MetricsSettings.ElasticsearchOsMemory),
		metricElasticsearchProcessCPUTime:                               newMetricElasticsearchProcessCPUTime(mbc.MetricsSettings.ElasticsearchProcessCPUTime),
		metricElasticsearchProcessCPUUsage:                              newMetricElasticsearchProcessCPUUsage(mbc.MetricsSettings.ElasticsearchProcessCPUUsage),
		metricElasticsearchProcessMemoryVirtual:                         newMetricElasticsearchProcessMemoryVirtual(mbc.MetricsSettings.ElasticsearchProcessMemoryVirtual),
		metricJvmClassesLoaded:                                          newMetricJvmClassesLoaded(mbc.MetricsSettings.JvmClassesLoaded),
		metricJvmGcCollectionsCount:                                     newMetricJvmGcCollectionsCount(mbc.MetricsSettings.JvmGcCollectionsCount),
		metricJvmGcCollectionsElapsed:                                   newMetricJvmGcCollectionsElapsed(mbc.MetricsSettings.JvmGcCollectionsElapsed),
		metricJvmMemoryHeapCommitted:                                    newMetricJvmMemoryHeapCommitted(mbc.MetricsSettings.JvmMemoryHeapCommitted),
		metricJvmMemoryHeapMax:                                          newMetricJvmMemoryHeapMax(mbc.MetricsSettings.JvmMemoryHeapMax),
		metricJvmMemoryHeapUsed:                                         newMetricJvmMemoryHeapUsed(mbc.MetricsSettings.JvmMemoryHeapUsed),
		metricJvmMemoryHeapUtilization:                                  newMetricJvmMemoryHeapUtilization(mbc.MetricsSettings.JvmMemoryHeapUtilization),
		metricJvmMemoryNonheapCommitted:                                 newMetricJvmMemoryNonheapCommitted(mbc.MetricsSettings.JvmMemoryNonheapCommitted),
		metricJvmMemoryNonheapUsed:                                      newMetricJvmMemoryNonheapUsed(mbc.MetricsSettings.JvmMemoryNonheapUsed),
		metricJvmMemoryPoolMax:                                          newMetricJvmMemoryPoolMax(mbc.MetricsSettings.JvmMemoryPoolMax),
		metricJvmMemoryPoolUsed:                                         newMetricJvmMemoryPoolUsed(mbc.MetricsSettings.JvmMemoryPoolUsed),
		metricJvmThreadsCount:                                           newMetricJvmThreadsCount(mbc.MetricsSettings.JvmThreadsCount),
	}
